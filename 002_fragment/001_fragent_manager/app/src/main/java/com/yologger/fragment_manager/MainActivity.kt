...
class MainActivity : AppCompatActivity() {
    ...
    val buttonFragmentA: Button by lazy { findViewById<Button>(R.id.activity_main_btn_fragment_a) }
    val buttonFragmentB: Button by lazy { findViewById<Button>(R.id.activity_main_btn_fragment_b) }
