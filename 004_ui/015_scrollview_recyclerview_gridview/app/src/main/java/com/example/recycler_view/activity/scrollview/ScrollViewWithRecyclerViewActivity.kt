...
import kotlinx.android.synthetic.main.activity_scroll_view_with_recycler_view.*

class ScrollViewWithRecyclerViewActivity : AppCompatActivity() {
    ...
    private fun initUI() {
        ...
        activity_scroll_view_with_recycler_view_rv.adapter = adapter
        val layoutManager = LinearLayoutManager(this)
        layoutManager.orientation = LinearLayoutManager.VERTICAL
        activity_scroll_view_with_recycler_view_rv.layoutManager = layoutManager
    }
